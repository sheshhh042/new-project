                    ...
                    <div class="col-lg-6 mb-4  ">
                        <div class="card shadow h-100">
                            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                <h6 class="m-0 font-weight-bold text-primary">Most Searched</h6>
                                <a href="{{ route('keywords.index') }}" class="btn btn-sm btn-primary">
                                    View All Searches
                                </a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <ul class="list-group">
                                        @foreach($mostSearchedKeywords as $keyword)
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <span class="badge bg-primary rounded-pill">{{ $keyword->total }} searches</span>
                                            </li>
                                        @endforeach
                                    </ul>
                                @endif
